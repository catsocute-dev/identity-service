...
public class AuthenticationService {
    ...
    public AuthenticationResponse refreshToken(RefreshTokenRequest request) throws ParseException, JOSEException {
        IntrospectRequest refreshToken = new IntrospectRequest(request.getRefreshToken());
        IntrospectResponse introspectResponse = introspect(refreshToken);
        if (!introspectResponse.isValid()) {
            return AuthenticationResponse.builder()
                .authenticated(false)
                .build();
        }
        SignedJWT signedJWT = SignedJWT.parse(refreshToken.getToken());
